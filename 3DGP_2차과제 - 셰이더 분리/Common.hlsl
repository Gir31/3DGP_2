...
StructuredBuffer<SRV_MIRROR_INFO> gMirror : register(t26);
...
Texture2D gUICoordinateTextures : register(t23); // UI용 텍스처 배열
Texture2D gUICoordinate2Textures : register(t24); // UI용 텍스처 배열
Texture2D gUIStartTextures : register(t25); // UI용 텍스처 배열
Texture2D gUIExitTextures : register(t27); // UI용 텍스처 배열
Texture2D gUIHeightTextures : register(t28); // UI용 텍스처 배열
Texture2D gUINumTextures : register(t29); // UI용 텍스처 배열
