...
public:
	...
	//==[GPU 리소스]================
	ID3D12Resource*									m_pd3dSphereDefault = NULL;
	ID3D12Resource*									m_pd3dSphereUpload = NULL;
	ID3D12Resource*									m_pd3dBoundingBoxDefault = NULL;
	ID3D12Resource*									m_pd3dBoundingBoxUpload = NULL;
