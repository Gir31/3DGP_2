...
void DebugPrintVector(const char* label, XMFLOAT3 v)
{
	char buffer[256];
...
void DebugPrintMatrix(const char* label, XMFLOAT4X4 m)
{
	char buffer[512];
	sprintf_s(buffer,
		"%s:\n"
	...
	D3D12_CPU_DESCRIPTOR_HANDLE dsvHandle)
{
	...
	if (m_ppShaders[UI_SHADER])
		m_ppShaders[UI_SHADER]->Render(pd3dCommandList, reflectionCamera, 0);
