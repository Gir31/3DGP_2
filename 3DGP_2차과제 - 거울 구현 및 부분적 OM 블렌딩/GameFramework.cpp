...
void CGameFramework::OnProcessingMouseMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	if (m_pGLM->GetCurrentLevel()) 
		m_pGLM->GetCurrentLevel()->OnProcessingMouseMessage(hWnd, nMessageID, wParam, lParam);
	switch (nMessageID)
	{
		case WM_LBUTTONDOWN:
		case WM_RBUTTONDOWN:
...
{    
	...
	if (m_pGLM->GetCurrentLevel()) 
		m_pGLM->GetCurrentLevel()->Render(m_pd3dDevice, m_pd3dCommandList,
			m_pCamera, m_pGLM->GetGraphicsRootSignature(), d3dDsvCPUDescriptorHandle);
