...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSInstancingLighting", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE CIlluminatedShader::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSInstancingLighting", "ps_5_1", &m_pd3dPixelShaderBlob));
}
