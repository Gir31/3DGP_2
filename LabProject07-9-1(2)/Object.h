...
public:
	...
	// Object.h (CGameObject 내부 public 영역)
public:
	ID3D12Resource* m_pd3dcbGameObject = NULL;
	VS_VB_INSTANCE* m_pcbMappedGameObject = NULL; 

	D3D12_GPU_DESCRIPTOR_HANDLE    m_d3dCbvGPUDescriptorHandle = { 0 };
	D3D12_CPU_DESCRIPTOR_HANDLE    m_d3dCbvCPUDescriptorHandle = { 0 };

	void SetCbvDescriptorHandles(D3D12_CPU_DESCRIPTOR_HANDLE cpuHandle, D3D12_GPU_DESCRIPTOR_HANDLE gpuHandle) {
		m_d3dCbvCPUDescriptorHandle = cpuHandle;
		m_d3dCbvGPUDescriptorHandle = gpuHandle;
	}
