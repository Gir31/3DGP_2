...
{
	if (m_GameLevelManager->GetCurrentLevel()) m_GameLevelManager->GetCurrentLevel()->OnProcessingMouseMessage(hWnd, nMessageID, wParam, lParam);
	switch (nMessageID)
	{
		case WM_LBUTTONDOWN:
		case WM_RBUTTONDOWN:
...
void CGameFramework::BuildObjects()
{
	...
	if (m_GameLevelManager->GetCurrentLevel()) m_GameLevelManager->GetCurrentLevel()->ReleaseUploadBuffers();
...
void CGameFramework::ReleaseObjects()
{
	...
	if (m_GameLevelManager->GetCurrentLevel()) m_GameLevelManager->GetCurrentLevel()->ReleaseObjects();
	if (m_GameLevelManager->GetCurrentLevel()) delete m_GameLevelManager->GetCurrentLevel();
}
...
void CGameFramework::ProcessInput()
{
	...
	if (GetKeyboardState(pKeysBuffer) && m_GameLevelManager->GetCurrentLevel()) 
		bProcessedByScene = m_GameLevelManager->GetCurrentLevel()->ProcessInput(pKeysBuffer);
...
void CGameFramework::AnimateObjects()
{
	...
	if (m_GameLevelManager->GetCurrentLevel()) 
		m_GameLevelManager->GetCurrentLevel()->AnimateObjects(fTimeElapsed);
