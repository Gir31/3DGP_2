...
#define PLAYER_TO_ENEMY (CG_PLAYER | CG_ENEMY)
#define PLAYER_TO_ITEM (CG_PLAYER | CG_ITEM)
#define PLAYER_TO_PROJECTILE (CG_PLAYER | CG_PROJECTILE)

#define ENEMY_TO_ENEMY (CG_ENEMY | CG_ENEMY)
#define ENEMY_TO_PROJECTILE (CG_ENEMY | CG_PROJECTILE)
