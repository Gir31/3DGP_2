...
public:
	...
	bool CheckCollisionGroup(const SRV_BOUNDINGBOX_INFO& A, const int CollisionGroupA, const XMFLOAT4X4& worldA, const SRV_BOUNDINGBOX_INFO& B, const int CollisionGroupB, const XMFLOAT4X4& worldB);
};